    ...
    <div ref={containerRef} className="relative h-[300vh]">
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden bg-black" style={{ zIndex: 30 }}>
        ...
        >
          {/* Top Left - Small tag */}
          <motion.div 
            className="absolute top-24 md:top-32 left-8 md:left-16"
          ...
          >
            ...
            <div className="w-32 h-[2px] bg-white/60 mx-auto" />
          </motion.div>

          {/* Top Right - Category */}
          <motion.div 
            className="absolute top-24 md:top-32 right-8 md:right-16 text-right"
            initial={{ opacity: 0, x: 30 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          <motion.div 
            className="absolute bottom-24 md:bottom-32 left-8 md:left-16 max-w-xs"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1, delay: 3.3, ease: [0.6, 0.05, 0.01, 0.9] }}
          >
            <p className="text-white text-xs md:text-sm uppercase tracking-wider font-light leading-relaxed">
          ...
          {/* Bottom Right - Year */}
          <motion.div 
            className="absolute bottom-24 md:bottom-32 right-8 md:right-16"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        >
          {/* Top Left - Small tag */}
          <div className="absolute top-24 md:top-32 left-8 md:left-16">
            <span className="text-white text-xs md:text-sm uppercase tracking-[0.3em] font-light">
              Interior
            </span>
          </div>
          ...
          {/* Top Right - Category */}
          <div className="absolute top-24 md:top-32 right-8 md:right-16 text-right">
            <span className="text-white text-xs md:text-sm uppercase tracking-[0.3em] font-light">
              Bali
            </span>
          </div>
          ...
          {/* Bottom Left - Description */}
          <div className="absolute bottom-24 md:bottom-32 left-8 md:left-16 max-w-xs">
            <p className="text-white text-xs md:text-sm uppercase tracking-wider font-light leading-relaxed">
          ...
          {/* Bottom Right - CTA */}
          <div className="absolute bottom-24 md:bottom-32 right-8 md:right-16 pointer-events-auto">
            <motion.button 
              className="text-white text-xs md:text-sm uppercase tracking-[0.3em] font-light border-b border-white/40 pb-1 hover:border-white transition-colors duration-300"
