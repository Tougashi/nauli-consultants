  ...
  return (
    <div className="bg-white text-black pb-6 md:pb-6">
      ...
      <FullScreenImageSection 
        imageSrc="/images/project-page/founders4.png"
        text="Luxury Living"
      ...
      <div className="w-[calc(100vw-24px)] md:w-[calc(100vw-36px)] relative left-1/2 -translate-x-1/2 mt-6 md:mt-6">
          <div className="grid grid-cols-3 md:grid-cols-3 w-full font-mono text-[10px] md:text-sm uppercase tracking-wide gap-6 px-2 md:px-0">
