  ...
  return (
    <div className="bg-white text-black mb-6">
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="w-full h-full flex flex-col justify-center p-6 md:p-12 lg:p-20 items-center gap-0">
            ...
            <div className="border-2 border-black max-w-xs w-full border-b-0">
                ...
                <div className="p-4 md:p-6 font-mono text-xs space-y-6">
                    <p>2021-2023</p>
                    <p>BALI INDONESIA</p>
            ...
            <div className="font-mono text-xs leading-relaxed max-w-xs w-full">
                <div className="border-2 border-black p-4 md:p-6 space-y-6">
                    <p>
        ...
        <div className="w-full h-full px-2 md:px-0 py-2 md:py-0  ">
            <img 
              src="/images/project-page/about.png" 
              alt="Villa Terra Interior" 
              className="w-full h-full object-cover md:pr-1 lg:pr-2 !md:mt-6"
            />
        </div>
      </div>
      ...
      <FullScreenImageSection 
        imageSrc="/images/project-page/about2.png"
        text="Villa Terra"
